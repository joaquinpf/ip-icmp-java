  ...
  public void show() {
    switch(tipo) {
      ...
      case BADPORT:
        ...
        break;
      case PARAMETROS:
        System.out.println("ERROR EN NUMERO DE PARAMETROS. Usos:" + masinfo);
        System.out.println("  TCP host_local, port_local, host_remoto, port_remoto Tipo");
        break;            
      ...
      case CONEXION_ILEGAL:
        System.out.println("ERROR: connection illegal for this process" + masinfo);
        break;
      ...
      case DOBLETCP:
        System.out.println("ERROR, se permite una unica instancia de TCP por aplicacion" + masinfo);
        break;
      ...
      case SIN_DATOS:
        System.out.println("ERROR en recepcion de datos, sin datos" + masinfo);
        break;
