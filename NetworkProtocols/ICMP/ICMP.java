...
public class ICMP implements ProtocolInterface, ICMPInterface {
	static Queue buffRem;  // Buffer de entrada remota a ICMP, lo llenan las interfaces
	static Queue buffLoc;  // Buffer de entrada local a ICMP, lo llenan las apps o ICMP
	private IP ip;
...
////////////////////////////////////////////////////////////////
	...
	public boolean handle(eventoN3 p) { //Es invocado cuando IP recibe un datagram que corresponde a ICMP
		...
		switch (icmpp.type){
			case ICMPMessage.ECHO_REQUEST:{
				System.out.println("Se encontro un paquete ICMP ECHO REQUEST proveniente de " + icmpp.getSourceAdrr());
				...
				try {
					...
					datagram.setsourceAddress(datagram.getDestAddr());
					...
					System.out.println("Error en la generacion y envio de ECHO REPLY. Posible ruta no encontrada.");
				}  
			}; 
			break;
			
			case ICMPMessage.ECHO_REPLY: {
				System.out.println("Se encontro un paquete ICMP ECHO REPLY proveniente de " + icmpp.getSourceAdrr());
				System.out.println("Paquete ICMP: " + icmpp.toString());
			};
			break;
			
			case ICMPMessage.DESTINATION_UNREACHABLE: {
				System.out.println("Se encontro un paquete ICMP DESTINATION UNREACHABLE proveniente de " + icmpp.getSourceAdrr());
				System.out.println("Paquete ICMP: " + icmpp.toString());
			...
			case ICMPMessage.SOURCE_QUENCH: {
				System.out.println("Se encontro un paquete ICMP SOURCE QUENCH proveniente de " + icmpp.getSourceAdrr());
				System.out.println("Paquete ICMP: " + icmpp.toString());
			...
			case ICMPMessage.REDIRECT: {
				System.out.println("Se encontro un paquete ICMP REDIRECT proveniente de " + icmpp.getSourceAdrr());
				System.out.println("Paquete ICMP: " + icmpp.toString());
			...
			case ICMPMessage.ROUTER_ADVERT: {
				System.out.println("Se encontro un paquete ICMP ROUTER ADVERT proveniente de " + icmpp.getSourceAdrr());
				System.out.println("Paquete ICMP: " + icmpp.toString());
			...
			case ICMPMessage.ROUTER_SOLICIT: {
				System.out.println("Se encontro un paquete ICMP ROUTER SOLICIT proveniente de " + icmpp.getSourceAdrr());
				System.out.println("Paquete ICMP: " + icmpp.toString());
			...
			case ICMPMessage.TIME_EXCEEDED: {
				System.out.println("Se encontro un paquete ICMP TIME EXCEEDED proveniente de " + icmpp.getSourceAdrr());
				System.out.println("Paquete ICMP: " + icmpp.toString());
			...
			case ICMPMessage.PARAMETER_PROBLEM: {
				System.out.println("Se encontro un paquete ICMP PARAMETER PROBLEM proveniente de " + icmpp.getSourceAdrr());
				System.out.println("Paquete ICMP: " + icmpp.toString());
			...
			case ICMPMessage.TIMESTAMP: {
				System.out.println("Se encontro un paquete ICMP TIMESTAMP proveniente de " + icmpp.getSourceAdrr());
				System.out.println("Paquete ICMP: " + icmpp.toString());
			...
			case ICMPMessage.TIMESTAMP_REPLY: {
				System.out.println("Se encontro un paquete ICMP TIMESTAMP REPLY proveniente de " + icmpp.getSourceAdrr());
				System.out.println("Paquete ICMP: " + icmpp.toString());
			...
			case ICMPMessage.INFORMATION_REQUEST: {
				System.out.println("Se encontro un paquete ICMP INFORMATION REQUEST proveniente de " + icmpp.getSourceAdrr());
				System.out.println("Paquete ICMP: " + icmpp.toString());
			...
			case ICMPMessage.INFORMATION_REPLY: {
				System.out.println("Se encontro un paquete ICMP INFORMATION REPLY proveniente de " + icmpp.getSourceAdrr());
				System.out.println("Paquete ICMP: " + icmpp.toString());
			...
			default: {
				System.out.print("El codigo del paquete ICMP es invalido. Tipo: " + icmpp.type);
				try {
					System.out.print(" tipo no implementado. Etiqueta: " + ICMPInterface.typeLabels[icmpp.type] + "/n");
				} 
				catch (Exception e) {
				}
				return false;  //No se proceso el paquete como un paquete ICMP, posiblemente sea un paquete correspondiente a IP
			}
		} //End del switch
	...
	public void send(byte type, byte code, IpAddress dest, Datagram data)
	{
		...
		switch (type) {
			...
			default: {
				System.out.println("El envio de mensaje ICMP fallo! No se encontro el tipo de mensaje " + type);
			}
		}
	...
	public void ping(IpAddress dest)
	{
		...
		try {
			...
			Datagram datagram = new Datagram(new byte[220]); //DATAGRAM que va a tirar error porq esta vacio!!!
	...
	public void receive_loc(eventoN3 pack) {
		...
		switch (opcion) {
			case eventoN3.SEND: // Recibe info para enviar
				...
				send(infoSend.getType(), infoSend.getCode(), infoSend.getDest(), infoSend.getData());
				break;
			default:
				break;
		}
	...
	public void receive_rem(eventoN3 indN2) {
		...
		System.out.println("Encontro requerimiento en cola remota de ICMP tipo " + opcion);
		// Segun la primitiva recibida, toma la accion que corresponda
		switch (opcion) {
