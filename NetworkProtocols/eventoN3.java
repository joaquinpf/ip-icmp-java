...
public class eventoN3 {
	...
	public static final int INFO_RECEIVED = 1; // Una interfaz anuncia que
												// recibio info para el
												// protocolo
	// de nivel 3 (IP, ICMP, ARP, IGMP)
	public static final int SEND = 2; // Un proceso de nivel mayor o igual a 3
										// (aplicacion,
	// transporte-TCP. UDP-, o nivel 3 -IP, etc-, solicita envio
	public static final byte LINK_DOWN = 3; // Interfaz anuncia la caida del
											// link (NO USADO POR AHORA)
	public static final byte LINK_UP = 4; // Interfaz anuncia link operativo (NO
											// USADO POR AHORA)
